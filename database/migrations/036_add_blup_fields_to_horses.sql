...
ALTER TABLE horses
  ...
  ADD COLUMN IF NOT EXISTS foreign_no TEXT,
...
COMMENT ON COLUMN horses.foreign_no IS 'Foreign registration number';
COMMENT ON COLUMN horses.owner IS 'Owner name from BLUP system';
